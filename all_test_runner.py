...
from tests.test_finance.test_contract import test_add_contract_for_client_A_UZB, test_add_contract_for_client_B_UZB, \
...
from tests.test_order.test_life_cycle import test_filial_create, test_room_add, test_robot_add, test_sub_filial_add, \
    test_user_create, test_adding_permissions_to_user, test_add_user_license, test_user_change_password, \
    test_price_type_add_UZB, test_price_type_add_USA, test_payment_type_add, test_sector_add, test_check_price_tag, \
    test_margin_add, test_room_attachment, test_init_balance, test_setting_consignment, test_setting_prepayment_on, \
    test_setting_prepayment_off
from tests.test_order.test_order import test_add_order_with_consignment, test_add_order_with_contract, \
    test_add_order_with_price_type_USA, test_order_add_for_sub_filial_select
from tests.test_order.test_order_change_status import test_change_status_from_draft_to_archive, \
    test_change_status_draft_and_archive, test_change_status_draft_and_cancelled, test_change_status_draft_and_delivered
from tests.test_order.test_order_demo import test_add_order_with_consignment_demo, \
    ...
    test_sales_report_constructor_demo, test_order_change_status_from_draft_to_cancelled_demo
...
from tests.test_order.test_order_report import test_check_report_for_order_list, \
    test_check_report_for_order_history_list, test_add_template_for_order_invoice_report, \
...
test_cases = [
        ...
        {"name": "Change Status From Draft To Cancelled Demo-A", "func": test_order_change_status_from_draft_to_cancelled_demo},
...
@pytest.mark.regression
def test_all_2(driver, test_data, save_data, load_data):
    base_page = BasePage(driver)
