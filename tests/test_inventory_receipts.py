...
def test_inventory_receipts(driver):
    ...
    margin_start = 20
    vat_start = 12
    amount_start = int(quantity) * price_start  # 1 * 120_000
    ##############################################################################
    ...
    price = numbers['price']  # 120_000
    margin = numbers['margin']  # 20
    vat = numbers['vat']  # 12
    amount = numbers['amount']  # 120_000
    ...
    total_amount = elements['start_total_amount']  # 1_200_000
    quantity = elements['quantity']  # 10
