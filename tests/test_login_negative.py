...
def run_test(driver, test_name, email, password, expect_success=False):
    ...
    if expect_success:
        ...
        success_message = "Dashboart sahifasiga o'tildi"
        failure_message = "Dashboart sahifasiga o'tilmadi"
    else:
...
#
#     if expect_success:
#         result = login_page.is_dashboard_visible()
#         success_message = "Dashboart sahifasiga o'tildi"
#         failure_message = "Dashboart sahifasiga o'tilmadi"
#     else:
#         result = login_page.is_error_message_displayed()
#         success_message = "Xato xabari ko'rsatildi"
#         failure_message = "Xato xabari ko'rsatilmadi"
#
#         if not result:
