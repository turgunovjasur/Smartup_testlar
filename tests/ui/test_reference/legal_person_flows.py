from pages.anor.mr.person.legal_person_add.legal_person_add import LegalPersonAdd
from pages.anor.mr.person.legal_person_list.legal_person_list import LegalPersonList
from pages.anor.mr.person.legal_person_view.legal_person_view import LegalPersonView
