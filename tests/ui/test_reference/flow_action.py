from pages.anor.mcg.action_add.action_add import ActionAdd
from pages.anor.mcg.action_list.action_list import ActionList
from pages.anor.mcg.action_view.action_view import ActionIdView
